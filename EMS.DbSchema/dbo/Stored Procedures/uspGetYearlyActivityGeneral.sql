...
-- Description:	Get Yearly Activity By Crew Type 
--General txref.iCrewTypeID = 2
-- =====================================================
--
--
...
CREATE PROCEDURE [dbo].[uspGetYearlyActivityGeneral](
	@iAgencyId int ,
...
BEGIN
	...
	--DECLARE @dtStartDate DATETIME = '12/01/2013'
	...
	FROM (
		...
		INNER JOIN tblXrefCrewTBVAC txref ON tbl.iTBVACLogID = txref.iTBVACLogID AND txref.iCrewTypeID = 2
