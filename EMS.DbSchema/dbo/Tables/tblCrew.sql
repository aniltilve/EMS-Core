CREATE TABLE [dbo].[tblCrew] (
    [iCrewID]      INT           IDENTITY (1, 1) NOT NULL,
    [iAgencyID]    INT           NULL,
    [iEMTID]       INT           NULL,
    [szUserName]   VARCHAR (100) NOT NULL,
    [szPassword]   VARCHAR (128) NOT NULL,
    [szFullName]   VARCHAR (100) NOT NULL,
    [szType]       VARCHAR (1)   NOT NULL,
    [bIsActive]    BIT           CONSTRAINT [DF_tblCrew_bIsActive] DEFAULT ((1)) NULL,
    [dtInserted]   DATETIME      CONSTRAINT [DF_tblCrew_dtInserted] DEFAULT (getdate()) NULL,
    [szInsertedBy] VARCHAR (64)  NULL,
    [dtUpdated]    DATETIME      NULL,
    [szUpdatedBy]  VARCHAR (64)  NULL,
    CONSTRAINT [PK_tblCrew_1] PRIMARY KEY CLUSTERED ([iCrewID] ASC),
    CONSTRAINT [FK_tblCrew_tblAgency] FOREIGN KEY ([iAgencyID]) REFERENCES [dbo].[tblAgency] ([iAgencyID])
);


GO

CREATE TRIGGER tblCrew_ChangeTracking ON tblCrew FOR INSERT, UPDATE
AS
...
GO
DISABLE TRIGGER [dbo].[tblCrew_ChangeTracking]
    ON [dbo].[tblCrew];
